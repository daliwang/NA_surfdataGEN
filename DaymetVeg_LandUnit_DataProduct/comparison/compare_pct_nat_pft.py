...
def main():
    ...
    for i in range(args.pft_start, args.pft_end + 1):
        ...
        axes[0].set_title(f"Global (on 1 km) PFT{i}")
        axes[0].set_xlabel("x")
        axes[0].set_ylabel("y")
        ...
        axes[1].set_title(f"Daymet 1 km PFT{i}")
        axes[1].set_xlabel("x")
        axes[1].set_ylabel("y")
        ...
        axes[2].set_title(f"NALCMS 1 km PFT{i}")
        axes[2].set_xlabel("x")
        axes[2].set_ylabel("y")
        ...
        axes2[0].set_title(f"Daymet - Global (on 1 km) PFT{i}")
        ...
        axes2[1].set_title(f"NALCMS - Global (on 1 km) PFT{i}")
        ...
        axes2[2].set_title(f"NALCMS - Daymet PFT{i}")
